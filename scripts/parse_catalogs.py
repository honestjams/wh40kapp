...
CATALOG_MAP = [
    # Library-based factions — characters/vehicles stored as type="model" in library
    ('Aeldari - Aeldari Library.cat',            'aeldari-craftworlds',          'Craftworlds (Aeldari)',  None,                              None,   ['unit', 'model']),
    ('Chaos - Chaos Daemons Library.cat',        'chaos-daemons',                'Chaos Daemons',          None,                              None,   ['unit', 'model']),
    ('Imperium - Astra Militarum - Library.cat', 'imperium-astra-militarum',     'Astra Militarum',        None,                              None,   ['unit', 'model']),
    ...
    # Main Chaos factions
    ('Chaos - Chaos Space Marines.cat',          'chaos-space-marines',          'Chaos Space Marines',    None,                              None,   ['unit', 'model']),
    ("Chaos - Emperor's Children.cat",           'chaos-emperors-children',      "Emperor's Children",     None,                              None,   ['unit', 'model']),
    ('Chaos - Death Guard.cat',                  'chaos-death-guard',            'Death Guard',            None,                              None,   ['unit', 'model']),
    ('Chaos - Thousand Sons.cat',                'chaos-thousand-sons',          'Thousand Sons',          None,                              None,   ['unit', 'model']),
    ('Chaos - World Eaters.cat',                 'chaos-world-eaters',           'World Eaters',           None,                              None,   ['unit', 'model']),
    ...
    ('Genestealer Cults.cat',                    'genestealer-cults',            'Genestealer Cults',
        ...
        ['unit', 'model']),
    # Imperium
    ('Imperium - Adepta Sororitas.cat',          'imperium-adepta-sororitas',    'Adepta Sororitas',       None,                              None,   ['unit', 'model']),
    ('Imperium - Adeptus Custodes.cat',          'imperium-adeptus-custodes',    'Adeptus Custodes',       None,                              None,   ['unit', 'model']),
    ('Imperium - Adeptus Mechanicus.cat',        'imperium-adeptus-mechanicus',  'Adeptus Mechanicus',     None,                              None,   ['unit', 'model']),
    # Space Marine sub-chapters — detachments pulled from parent SM catalog
    ('Imperium - Black Templars.cat', 'imperium-black-templars', 'Black Templars',
        'Imperium - Space Marines.cat',
        ['Black Spear Task Force', 'Gladius Task Force', 'Ironstorm Spearhead',
         'Firestorm Assault Force', 'Anvil Siege Force', '1st Company Task Force'],
        ['unit', 'model']),
    ...
    ('Imperium - Dark Angels.cat',    'imperium-dark-angels',   'Dark Angels',
        ...
        ['unit', 'model']),
    ('Imperium - Grey Knights.cat',   'imperium-grey-knights',  'Grey Knights',            None, None, ['unit', 'model']),
    ('Imperium - Space Marines.cat',  'imperium-space-marines', 'Space Marines',           None, None, ['unit', 'model']),
    ...
    ('Imperium - Ultramarines.cat',   'imperium-ultramarines',  'Ultramarines',
        ...
        ['unit', 'model']),
    ('Leagues of Votann.cat',         'leagues-of-votann',      'Leagues of Votann',       None, None, ['unit', 'model']),
    ('Necrons.cat',                   'necrons',                'Necrons',                 None, None, ['unit', 'model']),
    ('Orks.cat',                      'orks',                   'Orks',                    None, None, ['unit', 'model']),
    ("T'au Empire.cat",               'tau-empire',             "T'au Empire",             None, None, ['unit', 'model']),
